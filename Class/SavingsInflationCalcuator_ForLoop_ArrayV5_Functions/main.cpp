...
//Function Prototypes
void calcul8(float [],float[],unsigned short[],float,int);
void display(float [],float[],unsigned short[],int);
void heading(float,float,unsigned short);
void initial(unsigned char &,float &,float [],float &,
...
void initial(unsigned char &n,float &bp,float sc[],float &i,
...
void display(float sc[],float interest[],
        unsigned short yrDate[],int n){
    //Display the results
...
void calcul8(float sc[],float interest[],
