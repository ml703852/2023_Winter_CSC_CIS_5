...
void gamechoices(int chose) {
    ...
    string UsrName; 
    int UsrDpst, UsrBlnc; 
    char VorL, YorN, uexit, enter;
    unsigned int amount, bidamnt, rguess, dice, newBal, x;
    ...
    switch (chose) {
        ...
        string UsrName;
        char chose, HorS, again;
        int plyrsum, dealrsm, card;
        bool pturn, dturn, pbust, dbust;
